...
#[cfg(feature = "load-grammars")]
pub(crate) use package_json::PackageJson;
pub(crate) use package_json::PackageJsonData;
...
pub fn init(languages: Arc<LanguageRegistry>, fs: Arc<dyn Fs>, node: NodeRuntime, cx: &mut App) {
    ...
    #[cfg(not(any(feature = "load-grammars", feature = "notes")))]
    let built_in_languages: [LanguageInfo; 0] = [];
