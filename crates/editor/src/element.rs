...
impl EditorElement {
    ...
    fn register_actions(&self, window: &mut Window, cx: &mut App) {
        ...
        if !editor.read(cx).read_only(cx) {
            ...
            register_action(editor, window, Editor::toggle_markdown_heading_1);
            register_action(editor, window, Editor::toggle_markdown_heading_2);
            register_action(editor, window, Editor::toggle_markdown_heading_3);
            register_action(editor, window, Editor::toggle_markdown_heading_4);
            register_action(editor, window, Editor::toggle_markdown_heading_5);
            register_action(editor, window, Editor::toggle_markdown_heading_6);
            register_action(editor, window, Editor::toggle_markdown_unordered_list);
            register_action(editor, window, Editor::toggle_markdown_ordered_list);
            ...
            register_action(editor, window, Editor::toggle_markdown_strikethrough);
